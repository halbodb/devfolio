...
const Work = ({ clientWidth }) => {
  ...
  const handleChange = (position) => {
    ...
    switch (position) {
      case 0:
        height = inputRef.current.offsetTop - 165;
        checked[position] = true;
        break;
      case 1:
        height = inputRef.current.offsetTop - 105;
        checked[position] = true;
        break;
      case 2:
        height = inputRef.current.offsetTop - 65;
        checked[position] = true;
        break;
      default:
              ...
              >
                ...
                >
                  ...
                  {index == 0 &&
                    ...
                    >
                      <source src="/work/chaos.mp4" type="video/mp4" />
                    </video>}
                  ...
                  {index == 1 &&
                    <video
                      ...
                      className="border-gray-dark-5 border-[4px] h-[400px] bg-gray-dark-5"
                    >
                      <source src="/work/agridunya.mp4" type="video/mp4" />
                    </video>}
                  {index == 2 &&
                    <video
                      autoPlay
                      ...
                      className="border-gray-dark-5 border-[4px] h-[400px] bg-gray-dark-5"
                    >
                      <source src="/work/appicoders.mp4" type="video/mp4" />
                    </video>}
                  {index == 3 &&
                    <video
                      autoPlay
                      ...
                      className="border-gray-dark-5 border-[4px] h-[400px] bg-gray-dark-5"
                    >
                      <source src="/work/livestock.mp4" type="video/mp4" />
                    </video>}
                </div>
            ...
            <Fade bottom distance={"4rem"}>
              <div className="grid grid-cols-12 gap-4 place-items-center">
                <div className="col-span-12 flex flex-col">
                  <div className="py-5">
                    {WORK.map((job, index) => {
                      const { company } = job;
                      return (
                        <div key={company} className="py-3">
                          <Button
                            key={company}
                ...
                <div className="pt-10 col-span-12 flex flex-col justify-center items-center min-h-full">
                  <div className="bg-gray-dark-4 rounded-2xl px-10 py-10 w-96 h-full mx-16">
